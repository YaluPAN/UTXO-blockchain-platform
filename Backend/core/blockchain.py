'''
References:
https://github.com/Usama-Tariq/Basics-Of-Blockchain-Python
...
sys.path.append("/Users/wangzhuchen/Desktop/UTXO_Blockchain") # Change the path here
...
class Blockchain:
    ...
    def store_uxtos_in_cache(self):
        for tx in self.addTransactionsInBlock:
            ...
            # logging.info(f"Transaction added {tx.TxId} with amount: {tx.total_output_amount()}")
